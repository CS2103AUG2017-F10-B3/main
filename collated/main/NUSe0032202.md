...
return CollectionUtil.isAnyNonNull(this.name, this.phone, this.email, this.birthday,
...
```
###### \java\seedu\address\model\person\exceptions\LoadLookUpTableException.java
``` java
